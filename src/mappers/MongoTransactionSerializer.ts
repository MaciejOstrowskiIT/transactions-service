...
export class MongoTransactionSerializer implements Serializer<TransactionDb, Transaction> {
  ...
  mapToEntity(document: TransactionDb): Transaction {
    return new Transaction(document._id, document.debit, document.credit, document.date, 
        document.senderName, document.senderAccount, document.receiverName, document.receiverAccount, document.value);
  }
